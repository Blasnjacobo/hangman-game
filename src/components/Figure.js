...
export default function Figure({wrongLetters}) {
  ...
  return (
        <svg height="250" width="200" className="figure-container">
            ...
            {errors > 0 && <line x1="135" y1="80" x2="152" y2="75"/>}
            {errors > 0 && <circle cx="135" cy="65" r="4" />}
            {errors > 0 && <circle cx="150" cy="63" r="3" />}
            {errors > 0 && <text className="dude" x="105" y="130">Help dude!</text>}
            {/*<!-- Body -->*/}
